...
- Buttons must visually contrast with their surrounding page or card surface and should not share the general background color. Use a white surface for secondary and outlined actions when they appear on the warm application background.
