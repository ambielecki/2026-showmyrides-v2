...
# Project Description
This is an API for an accompanying Vue SPA in ../frontend

## Auth
The application will use Laravel Fortify for basic authentication with Laravel Sanctum to manage sessions with the frontend
